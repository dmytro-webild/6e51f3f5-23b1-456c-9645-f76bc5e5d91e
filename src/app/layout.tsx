...
export const metadata: Metadata = {
  title: "ShopHub - Premium Online Shopping & E-Commerce",
  description: "Shop thousands of products with secure checkout, fast shipping, and exceptional customer service. Your trusted online store.",
  keywords: "e-commerce, online store, shopping, products, retail",
  openGraph: {
    title: "ShopHub - Your Ultimate Online Store",
    description: "Discover premium products with secure checkout and fast delivery.",
    siteName: "ShopHub",
    type: "website",
  },
  twitter: {
    ...
    description: "Your trusted destination for quality products and seamless shopping.",
  },
  robots: {
    index: true,
    follow: true,
